...
class Attendance:
    ...
    def __init__(self,root):
        ...
        right_frame.place(x=680,y=10,width=660,height=480)#x=680,y=10,width=660,height=480
        ...
        self.attendanceReport.bind("<ButtonRelease>",self.get_cursor_right)#get_cursor_right
        self.fetch_data()
    ...
    def exportCsv(self):
        try:
            ...
            with open(fln,mode="w",newline="") as myfile:
                ...
                messagebox.showinfo("Successfull","Export Data Successfully!",parent=self.root)
        except Exception as es:
                messagebox.showerror("Error",f"Due to: {str(es)}",parent=self.root)    
